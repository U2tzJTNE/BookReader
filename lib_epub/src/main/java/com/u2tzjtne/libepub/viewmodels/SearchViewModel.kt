package com.u2tzjtne.libepub.viewmodels
...
import com.u2tzjtne.libepub.model.locators.SearchItemType
...
class SearchViewModel : ViewModel() {
    ...
    private var r2StreamerApi: R2StreamerApi? = EpubReader.get().r2StreamerApi
