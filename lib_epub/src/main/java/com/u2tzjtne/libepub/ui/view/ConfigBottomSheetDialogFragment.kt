...
import com.u2tzjtne.libepub.model.event.ReloadDataEvent
...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    private lateinit var activityCallback: ReadActivityCallback
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity is ReadActivity)
            activityCallback = activity as ReadActivity
