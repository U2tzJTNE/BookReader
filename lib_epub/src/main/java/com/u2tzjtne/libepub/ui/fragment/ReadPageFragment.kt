package com.u2tzjtne.libepub.ui.fragment
...
import com.u2tzjtne.libepub.model.event.*
...
import com.u2tzjtne.libepub.ui.base.HtmlTask
import com.u2tzjtne.libepub.ui.base.HtmlTaskCallback
import com.u2tzjtne.libepub.ui.base.HtmlUtil
import com.u2tzjtne.libepub.ui.view.FolioWebView
import com.u2tzjtne.libepub.ui.view.LoadingView
import com.u2tzjtne.libepub.ui.view.VerticalSeekbar
import com.u2tzjtne.libepub.ui.view.WebViewPager
 ...
 */
class ReadPageFragment : Fragment(),
    HtmlTaskCallback, MediaControllerCallbacks, FolioWebView.SeekBarListener {

    companion object {

        @JvmField
        val LOG_TAG: String = ReadPageFragment::class.java.simpleName
        ...
        @JvmStatic
        fun newInstance(spineIndex: Int, bookTitle: String, spineRef: Link, bookId: String): ReadPageFragment {
    ...
    private var mActivityCallback: ReadActivityCallback? = null
    ...
    override fun onCreateView(
        ...
        if (activity is ReadActivityCallback)
            mActivityCallback = activity as ReadActivityCallback?
    ...
    private fun initWebView() {
        ...
        if (activity is ReadActivityCallback)
            mWebview!!.setFolioActivityCallback((activity as ReadActivityCallback?)!!)
        ...
        mWebview!!.addJavascriptInterface(this, "ReadPageFragment")
    ...
    private val webViewClient = object : WebViewClient() {
        ...
        override fun onPageFinished(view: WebView, url: String) {
            ...
            this@ReadPageFragment.rangy = rangy
            if (!rangy.isEmpty())
                loadRangy(rangy)
    ...
    private val webChromeClient = object : WebChromeClient() {
        ...
        override fun onJsAlert(view: WebView, url: String, message: String, result: JsResult): Boolean {
            ...
            if (!this@ReadPageFragment.isVisible)
                return true
