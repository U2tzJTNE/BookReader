...
import com.u2tzjtne.libepub.ui.adapter.ListViewType
import com.u2tzjtne.libepub.ui.adapter.OnItemClickListener
import com.u2tzjtne.libepub.ui.adapter.SearchAdapter
import com.u2tzjtne.libepub.ui.view.FolioSearchView
import com.u2tzjtne.libepub.util.AppUtil
import com.u2tzjtne.libepub.util.UiUtil
import com.u2tzjtne.libepub.viewmodels.SearchViewModel
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if (TextUtils.isEmpty(newText)) {
                    ...
                    val intent = Intent(ReadActivity.ACTION_SEARCH_CLEAR)
    ...
    override fun onItemClick(
        ...
        if (adapter is SearchAdapter) {
            if (viewHolder is SearchAdapter.NormalViewHolder) {
                ...
                intent.putExtra(SearchAdapter.DATA_BUNDLE, searchAdapterDataBundle)
                intent.putExtra(ReadActivity.EXTRA_SEARCH_ITEM, viewHolder.searchLocator as Parcelable)
                intent.putExtra(BUNDLE_SAVE_SEARCH_QUERY, searchView.query)
