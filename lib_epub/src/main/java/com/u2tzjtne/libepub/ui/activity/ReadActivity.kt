...
import com.u2tzjtne.libepub.model.event.MediaOverlayPlayPauseEvent
import com.u2tzjtne.libepub.model.locators.ReadLocator
import com.u2tzjtne.libepub.model.locators.SearchLocator
import com.u2tzjtne.libepub.ui.adapter.FolioPageFragmentAdapter
import com.u2tzjtne.libepub.ui.adapter.SearchAdapter
import com.u2tzjtne.libepub.ui.fragment.ReadPageFragment
import com.u2tzjtne.libepub.ui.fragment.MediaControllerFragment
import com.u2tzjtne.libepub.ui.view.ConfigBottomSheetDialogFragment
import com.u2tzjtne.libepub.ui.view.DirectionalViewpager
import com.u2tzjtne.libepub.ui.view.FolioAppBarLayout
import com.u2tzjtne.libepub.ui.view.MediaControllerCallback
import com.u2tzjtne.libepub.util.AppUtil
import com.u2tzjtne.libepub.util.FileUtil
import com.u2tzjtne.libepub.util.UiUtil
...
class ReadActivity : AppCompatActivity(),
    ReadActivityCallback, MediaControllerCallback,
    ...
    companion object {
        ...
        @JvmField
        val LOG_TAG: String = ReadActivity::class.java.simpleName

        const val INTENT_EPUB_SOURCE_PATH = "com.u2tzjtne.libepub.epub_asset_path"
        const val INTENT_EPUB_SOURCE_TYPE = "epub_source_type"
        const val EXTRA_READ_LOCATOR = "com.u2tzjtne.libepub.extra.READ_LOCATOR"
    ...
    private val currentFragment: ReadPageFragment?
        get() = if (mFolioPageFragmentAdapter != null && mFolioPageViewPager != null) {
            mFolioPageFragmentAdapter!!
                .getItem(mFolioPageViewPager!!.currentItem) as ReadPageFragment
        } else {
            null
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mEpubSourceType == EpubSourceType.RAW) {
            ...
            mEpubFilePath = intent.extras!!
                .getString(ReadActivity.INTENT_EPUB_SOURCE_PATH)
        }
    ...
    fun startContentHighlightActivity() {
        ...
        val intent = Intent(this@ReadActivity, ContentHighlightActivity::class.java)
    ...
    override fun onDirectionChange(newDirection: Config.Direction) {
        ...
        var readPageFragment: ReadPageFragment? = currentFragment ?: return
        entryReadLocator = readPageFragment!!.getLastReadLocator()
        val searchLocatorVisible = readPageFragment.searchLocatorVisible
        ...
        readPageFragment = currentFragment ?: return
        searchLocatorVisible?.let {
            readPageFragment.highlightSearchLocator(searchLocatorVisible)
        }
    }
    ...
    override fun getActivity(): WeakReference<ReadActivity> {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RequestCode.SEARCH.value) {
            ...
            if (resultCode == SearchActivity.ResultCode.ITEM_SELECTED.value) {
                ...
                // In case if SearchActivity is recreated due to screen rotation then ReadActivity
    ...
    private fun configFolio() {
        ...
        mFolioPageViewPager!!.setOnPageChangeListener(object : DirectionalViewpager.OnPageChangeListener {
            ...
            override fun onPageScrollStateChanged(state: Int) {
                ...
                if (state == DirectionalViewpager.SCROLL_STATE_IDLE) {
                    ...
                    var folioPageFragment = mFolioPageFragmentAdapter!!.getItem(position - 1) as ReadPageFragment?
                    ...
                    folioPageFragment = mFolioPageFragmentAdapter!!.getItem(position + 1) as ReadPageFragment?
                    if (folioPageFragment != null) {
                        folioPageFragment.scrollToFirst()
                        if (folioPageFragment.mWebview != null)
                            folioPageFragment.mWebview!!.dismissPopupWindow()
        ...
        if (searchLocator != null) {
            ...
            if (savedInstanceState == null) {
                readLocator = intent.getParcelableExtra(ReadActivity.EXTRA_READ_LOCATOR)
    ...
    private fun clearSearchLocator() {
        ...
        for (i in fragments.indices) {
            val folioPageFragment = fragments[i] as ReadPageFragment?
        ...
        if (savedStateList != null) {
            for (i in savedStateList.indices) {
                ...
                bundle?.putParcelable(ReadPageFragment.BUNDLE_SEARCH_LOCATOR, null)
            }
        }
    }
}