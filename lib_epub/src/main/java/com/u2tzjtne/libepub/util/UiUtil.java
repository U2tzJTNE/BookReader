...
import com.u2tzjtne.libepub.AppContext;
import com.u2tzjtne.libepub.ui.view.UnderlinedTextView;
...
public class UiUtil {
    ...
    public static Typeface getFont(Context c, String name) {
        synchronized (FONT_CACHE) {
            if (FONT_CACHE.get(name) != null) {
                SoftReference<Typeface> ref = FONT_CACHE.get(name);
                if (ref.get() != null) {
                    return ref.get();
                }
            }
